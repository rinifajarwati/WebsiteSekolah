...
<body>
    ...
    <div class="container-costum">
        <div class="justify-content-center pl-3 pr-3 pt-5 pb-5">
            <h4 style="text-align: center;">Berita</h4>
            <h4 style="text-align: center;">SDN 001 Tanjung Selor</h4>
            <?php
            include "../config/koneksi.php";
            $ambildata = mysqli_query($conn, "SELECT * FROM beritahome WHERE id='$key'");
            while ($tampil = mysqli_fetch_array($ambildata)) {
                echo "
                <img class='card-img-top' src='../image/$tampil[image]' width = '400px' height='400px' alt=''>
