    ...
    <div class="container-costum">
        <div class="justify-content-center pl-3 pr-3 pt-5 pb-5">
            ...
            <div class='edit' style='float: right;'>
                <?php if ("true" === $admin) {
                    echo
                    "<button id='btn2'><a href='tambah_fotokegiatan.php?idfotokegiatan=$key'>Tambah Foto</a></button>";
                }
                ?>
            </div>
        </div>
        <div class="row">
            <?php
            include "../config/koneksi.php";
            $ambildata = mysqli_query($conn, "SELECT * FROM fotokegiatan WHERE id_foto='$key'");
            while ($tampil = mysqli_fetch_array($ambildata)) {
                ...
                $idfotokegiatan = $tampil["id"];
                echo "<div class='edit' style='float: center;'>";
                if ('true' === $admin) {
                    echo "<p><a href='hapus_fotokegiatan.php?idfotokegiatan=$idfotokegiatan&key=$key' class='btn btn-primary'>Hapus</a></p>";
                }
                echo "  </div></div>
            </a> </div>
            ";
