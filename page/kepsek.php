        ...
        <div>
            <div id="person">
                <div class="justify-content-center pl-3 pr-3 pt-5 pb-5">
                    <h4 style="text-align: center;">Kepala Sekolah</h4>
                    <h4>SDN 001 Tanjung Selor</h4>
                </div>
                <?php
                $ambildata = mysqli_query($conn, "SELECT * FROM guru_staff WHERE kepsek='1'");
                while ($tampil = mysqli_fetch_array($ambildata)) {
                    echo "
                        <img src='../image/$tampil[image]' alt='workingspace' class='img-fluid'>
                        <p>Nama : $tampil[nama]</p>
                        <p>Lahir : $tampil[lahir]</p>
                        <p>NIP : $tampil[nip]</p>
                        <p>NUPTK : $tampil[nuptk]</p>
                     ";
                }
                ?>
