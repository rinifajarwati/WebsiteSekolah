    ...
    <div class="berita">
        <div class="container">
            <div class="justify-content-center pl-3 pr-3 pt-5 pb-5">
                <h4 style="text-align: center;">Ekstrakulikuler</h4>
                <h4 style="text-align: center;">SDN 001 Tanjung Selor</h4>
                <div class="edit" style="float: right;">
                    <?php if ("true" === $admin) {
                        $idekskul = $tampil["id"];
                        echo
                        "<button id='btn2'><a href='tambah_ekskul.php'>Tambah Ekstrakulikuler</a></button>";
                    }
                    ?>
                </div>
            </div>
            <div class="row">
                <?php
                $ambildata = mysqli_query($conn, "SELECT * FROM ekskul");
                while ($tampil = mysqli_fetch_array($ambildata)) {
                    echo "
                <div class='col'>    
                    ...
                    if ("true" === $admin) {
                        ...
                        echo
                        "<button id='btn2'><a href='edit_ekskul.php?idekskul=$idekskul'>Edit</a></button></div>";
                        echo "
                        <div class='edit' style='float: right;'>";
                        echo
                        "<button id='btn2'><a href='hapus_ekskul.php?idekskul=$idekskul'>Hapus</a></button></div>";
                    }
                    echo "
                        </div>
                     </div>
