...
<body>
    ...
    <main class="container">
        <div class="content row workingspace">
            <div class="col-6">
                <?php
                $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE title='Sejarah'");
                while ($tampil = mysqli_fetch_array($ambildata)) {
                    echo "
            ...
            <div class="col-5">
                <h4 style="text-align: center;">Sejarah</h4>
                ...
                <?php if ("true" === $admin) {
                    $idedit = 'isisejarah';
                    echo
                    "<button id='btn2'><a href='edit_sejarah.php?idsejarah=$idsejarah'>Edit</a></button>";
                }
                ?>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-md-0 mb-3">
                    ...
                    <ul class="list-unstyled">
                        <li>
                            <p>
                            <address>Jln. Kol. H. Soetadji No. 42 RT. 6 Tanjung Selor Hilir, Tanjung Selor, Kabupaten Bulungan, Kalimantan Utara, 77212</address>
                            </p>
                        </li>
                        <li>
