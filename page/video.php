...
<body>
    ...
    <main class="main">
        <div class="container">
            <div class="justify-content-center pl-3 pr-3 pt-5 pb-5">
                ...
                <div class="edit" style="float: right;">
                    <?php if ("true" === $admin) {
                        $idvideo = $tampil["id"];
                        echo
                        "<button id='btn2'><a href='tambah_video.php'>Tambah Video</a></button>";
                    }
                    ?>
                </div>
            </div>
            ...
            <?php
            $ambildata = mysqli_query($conn, "SELECT * FROM video");
            while ($tampil = mysqli_fetch_array($ambildata)) {
                echo "<div class='card' style='margin-top:55px'>
                    <div class='col-12' id='foto'>
                    <table>
                    <h5 style='text-align: center'>$tampil[content]</h5>
                    <td width='200px' style='vertical-align: top'>$tampil[link]</td>";
                if ("true" === $admin) {
                    $idvideo = $tampil["id"];
                    echo "<div class='edit' style='float: right;'>";
                    echo "<button id='btn2'><a href='hapus_video.php?idvideo=$idvideo'>Hapus</a></button></div>";
                }
                echo "</table> </div></div>";
            }
            ?>
