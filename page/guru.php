...
<body>
    ...
    <main class="main">
        <div class="container">
            <div class="justify-content-center pl-3 pr-3 pt-5 pb-5">
                ...
                <div class="edit" style="float: right;">
                    <?php if ("true" === $admin) {
                        $idstaff = $tampil["id"];
                        echo
                        "<button id='btn2'><a href='tambah_guru.php'>Tambah Guru</a></button>";
                    }
                    ?>
                </div>
            </div>
            <div id="person">
                <?php
                $ambildata = mysqli_query($conn, "SELECT * FROM guru_staff WHERE kepsek ='1' OR guru ='1'");
                while ($tampil = mysqli_fetch_array($ambildata)) {
                    echo "
        <div class='card'>
                <div class='col-12' id='foto'>
                    <img class='img-top'  src='../image/$tampil[image]' alt='workingspace''>
             
                        <table alt='workingspace'>
                            <tr>
                                <td width='200px' style='vertical-align: top'>Nama</td>
                                <td width='20px' style='vertical-align: top'> : </td>
                                <td>$tampil[nama]</td>
                            </tr>
                            <tr>
                                <td width='200px' style='vertical-align: top'>Tempat/Tanggal Lahir</td>
                                <td width='20px' style='vertical-align: top'> : </td>
                                <td>$tampil[lahir]</td>
                            </tr>
                            <tr>
                                <td width='200px' style='vertical-align: top'>NIP</td>
                                <td width='20px' style='vertical-align: top'> : </td>
                                <td>$tampil[nip]</td>
                            </tr>
                            <tr>
                                <td width='200px' style='vertical-align: top'>NUPTK</td>
                                <td width='20px' style='vertical-align: top'> : </td>
                                <td>$tampil[nuptk]</td>";
                    if ("true" === $admin) {
                        $idguru = $tampil["id"];
                        echo " <td width='300px' style='vertical-align: top'>
                        <div class='edit' style='float: right;'>
                                    <button id='btn2'><a href='edit_guru.php?idguru=$idguru'>Edit</a></button>
                                    <button id='btn2'><a href='hapus_guru.php?idguru=$idguru'>Hapus</a></button>
                                </td>
                                </div>";
                    }
                    echo " </tr></table>
    ...
    <!-- Akhir Workingspace Guru-->
    <!-- Workingspace Staff-->
    <main class="main">
        <div class="container">
            <div class="justify-content-center pl-3 pr-3 pt-5 pb-5">
                <h4 style="text-align: center;">Daftar Staff</h4>
                <h4 style="text-align: center;">SDN 001 Tanjung Selor</h4>
                <div class="edit" style="float: right;">
                    <?php if ("true" === $admin) {
                        $idstaff = $tampil["id"];
                        echo
                        "<button id='btn2'><a href='tambah_guru.php'>Tambah Staff</a></button>";
                    }
                    ?>
                </div>
            </div>
                ...
                <div class='col-12' id='foto'>
                    <img class='img-top'  src='../image/$tampil[image]' alt='workingspace''>
                        ...
                        <table alt='workingspace'>
                            ...
                            <tr>
                                <td width='200px' style='vertical-align: top'>Bidang</td>
                                <td width='20px' style='vertical-align: top'> : </td>
                                <td>$tampil[bidang]</td>";
