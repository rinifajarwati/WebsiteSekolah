...
<body>
    <header>
        ...
        <div class="tulisan">
            <marquee style="color:  blue"><b> Selamat Datang Di Website SDN 001 Tanjung Selor. Pengelola : Rini & Reni</b>
            </marquee>
        </div>
    </header>
    ...
    <div class="container-costum">
        <div class="justify-content-center pl-3 pr-3 pt-5 pb-5">
            <h4 style="text-align: center;">Foto Kegiatan</h4>
            <h4 style="text-align: center;">SDN 001 Tanjung Selor</h4>
            <div class='edit' style='float: right;'>
                <?php if ("true" === $admin) {
                    $idfoto = $tampil["id"];
                    echo
                    "<button id='btn2'><a href='tambah_foto.php?idfoto=$idfoto'>Tambah Album Foto</a></button>";
                }
                ?>
            </div>
        </div>
        <div class="row">
            <?php
            $ambildata = mysqli_query($conn, "SELECT * FROM foto");
            while ($tampil = mysqli_fetch_array($ambildata)) {
                $idfoto = $tampil["id"];
                echo " <div class='contentfoto'> <a href='fotokegiatan.php?myVar1=$tampil[id]'>
                     <div class='content-overlay'></div> <img class='content-image' src='../image/$tampil[image]' width='50px' height='300px' >
                     <div class='content-details fadeIn-bottom'>
                         <h3 class='content-title'>$tampil[nama]</h3>
                         <p class='content-text'><i class='fa fa-map-marker'></i>$tampil[keterangan]</p>";

                if ('true' === $admin)
                    echo "<div class='edit' style='float: center;'>
                <p><a href='edit_foto.php?idfoto=$idfoto' class='btn btn-primary'>Edit</a></p></div>
                <div class='edit' style='float: center;'>
                <p><a href='hapus_foto.php?idfoto=$idfoto' class='btn btn-primary'>Hapus</a></p></div>";
                echo "  </div>
                 </a> </div> 
                 ";
            }
