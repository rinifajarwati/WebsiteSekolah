...
<body>
    ...
    <main class="container-fluid">
        <div class="content row workingspace">
            <div class="col-6">
                <?php
                $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE title='visi'");
                while ($tampil = mysqli_fetch_array($ambildata)) {
                    echo "
            ...
            <div class="col-5">
                ...
                <h4 style="text-align: center;"><span>Visi</span></h4>
                <?php
                $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE title='visi'");
                while ($tampil = mysqli_fetch_array($ambildata)) {
                    echo "
                ...
                <h4 style="text-align: center;"><span>Misi</span></h4>
                <?php
                $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE title='misi'");
                while ($tampil = mysqli_fetch_array($ambildata)) {
                    echo "
                ...
                if ("true" === $admin) {
                    $idvisimisi = 'visimisi';
                    echo
                    "<button id='btn2'><a href='edit_visimisi.php?idvismisi=$idvismisi'>Edit</a></button>";
                }
                ?>
            </div>
        </div>
