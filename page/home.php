    ...
    <header>
        ...
        <div class="edit" style="float: right;">
            <?php if ("true" === $admin) {
                $idedit = 'isifoto';
                echo
                "<button id='btn2'><a href='edit_banner.php?idfoto=$idfoto'>Edit</a></button>";
            }
            ?>
            <?php if ("true" === $admin) {
                $idfoto = $tampil["id"];
                echo
                "<button id='btn2'><a href='tambah_banner.php?idfoto$idfoto'>Tambah foto</a></button>";
            }
            ?>
        </div>
        <div class="tulisan">
    ...
    <div class="berita">
        <div class="container">
            <div class="justify-content-center pl-3 pr-3 pt-5 pb-5">
                <h4 style="text-align: center;">Top Berita</h4>
                <h4 style="text-align: center;">SDN 001 Tanjung Selor</h4>
                <div class='edit' style='float: right;'>
                    <?php if ("true" === $admin) {
                        $idberitahome = $tampil["id"];
                        echo
                        "<button id='btn2'><a href='tambah_berita.php?idberitahome=$idberitahome'>Tambah Berita</a></button>";
                    }
                    ?>
                </div>
            </div>
            <div class="row">
                <?php
                $ambildata = mysqli_query($conn, "SELECT * FROM beritahome");
                while ($tampil = mysqli_fetch_array($ambildata)) {
                    echo "
                <div class='col'>
                    <div class='card' id='ubah'>
                            ...
                            <div class='card-body'>
                                ...
                                <span>$tampil[content]</span>
                                <div class='content'> <a href='berita.php?myVar2=$tampil[id]'>
                                 <button type='button' class='btn btn-info'>Lihat Berita</button>
                                </a></div>";
                    ...
                    if ("true" === $admin) {
                        ...
                        <div class='edit' style='float: right;'>";
                        echo
                        "<button id='btn2'><a href='edit_beritahome.php?idberitahome=$idberitahome'>Edit</a></button></div>";
                        echo "
                        <div class='edit' style='float: right;'>";
                        echo
                        "<button id='btn2'><a href='hapus_home.php?idberitahome=$idberitahome'>Hapus</a></button></div>";
                    }
                    echo "
                            </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-md-0 mb-3">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li>
                            <p>Email:</strong><a href="mailto:sdnsatu_tanjungselor@yahoo.com">sdnsatu_tanjungselor@yahoo.com</a></p>
                        </li>
                    </ul>
                </div>
                <!-- Grid column -->
