...
<body>
    ...
    <main class="container">
        <div class="justify-content-center pl-3 pr-3 pt-5 pb-5">
            ...
            <div class="edit" style="float: right;">
                <?php if ("true" === $admin) {
                    $idedit = 'isistruktur';
                    echo
                    "<button id='btn2'><a href='edit_struktur.php?idstruktur=$idstruktur'>Edit Struktur</a></button>";
                }
                ?>
            </div>
        </div>
        <div id="person">
            <?php
            $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE title='struktur'");
            while ($tampil = mysqli_fetch_array($ambildata)) {
                echo "
